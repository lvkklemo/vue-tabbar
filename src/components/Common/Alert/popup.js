 ...
 * 关闭 消息确认框
 */
export function isConfirm_confirm(text) {
	document.getElementById("popup-backdrop").style.display = "none";
...
export {confirms,notice,prompts}